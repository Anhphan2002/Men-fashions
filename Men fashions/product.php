...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Lấy làm tiếc! Chúng là duy nhất'.$current_p_qty.'các mặt hàng trong kho';
		?>
    ...
    <div class="review-form">
        ...
        <?php else: ?>
            <p class="error">
                ...
                <a href="login.php" style="color:red;text-decoration: underline;font-size: 20px;"><?php echo LANG_VALUE_9; ?></a>
            </p>
        <?php endif; ?>                         
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.edit-review').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const commentSpan = document.getElementById('comment_' + reviewId);
            const currentComment = commentSpan.innerText;
            ...
            if (newComment !== null) {
                ...
                fetch('update_review.php', {
                    ...
                    body: JSON.stringify({ rt_id: reviewId, comment: newComment })
                })
        ...
        button.addEventListener('click', function() {
            ...
            if (confirm('Are you sure you want to delete this review?')) {
                ...
                fetch('delete_review.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ rt_id: reviewId })
                })
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <!-- chi tiết sản phẩm -->
                                <p>
                                    <a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo LANG_VALUE_154; ?></a>
                                </p>
                            </div>
                        </div>
                        <?php
