...
<head>
	...
	<!-- chia sẻ sản phẩm đến các trang mạng xã hội -->
...
<div class="header">
	<div class="container">
		<div class="row inner">
			<div class="col-md-3 logo" style="width: 10%;>
				<a href="index.php"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"></a>
			</div>
			<div class="col-md-4 search-area" style="width: 45%;">
			...
			<div class="col-md-5 right" style="width: 45%;">
				<ul>
					<?php
					...
					if(isset($_SESSION['cart_p_id'])) {
						...
						echo number_format($table_total_price, '3', '.','');
					} else {
						echo '0.00';
					}
				...
				<div class="menu-container">
					<div class="menu">
						<ul>
							...
							foreach ($result as $row) {
								?>						
									<li><a href="product-category.php?id=<?php echo $row['tcat_id']; ?>&type=top-category"><?php echo $row['tcat_name']; ?> <i class="fa fa-angle-down" aria-hidden="true"></i></a>
