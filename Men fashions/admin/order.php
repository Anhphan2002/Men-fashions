...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Email của bạn cho khách hàng được gửi thành công.';
    }
}
?>
<?php
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                ...
                                echo ', <b>Unit Price:</b> '.$row1['unit_price'].'đ)';
                                echo '<br><br>';
                           }
                           ?>
                        </td>
                        ...
                        <td>
                            ...
                            <?php
                                if($row['payment_status']=='Pending'){
                                    ?>
                                    <a href="order-change-status.php?id=<?php echo $row['id']; ?>&task=Completed" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Xác nhận hoàn thành</a>
                                    <?php
                                }
                            ?>
                        </td>
                        <td>
                            ...
                            if($row['payment_status']=='Completed') {
                                if($row['shipping_status']=='Pending'){
                                    ?>
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=Completed" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Xác nhận hoàn thành</a>
                                    <?php
                                }
                            }
                            ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger btn-ok">Xóa bỏ</a>
            </div>
        </div>
    </div>
</div>
