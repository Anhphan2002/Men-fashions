		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
                                    Bạn phải điền vào tất cả thông tin thanh toán và giao hàng từ bảng điều khiển của mình để thanh toán đơn đặt hàng. Vui lòng điền thông tin vào <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">link này</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">	                		
	                            <div class="row">
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select3" id="advFieldsStatus">
                                    ...
                                    <!-- <form action="payment/momo/init.php" method="post" id="momo_form">
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                    ...
                                    <form action="payment/zalopay/init.php" method="post" id="zalopay_form">
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label for="">Thanh toán ZaloPay</label><br>
                                            <p>Thanh toán bằng ZaloPay</p>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form5">
                                        </div>
                                    </form> -->
	                            </div>
