...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn một danh mục cấp trung bình<br>";
    }
    ...
    if(empty($_POST['p_current_price'])) {
        $valid = 0;
        $error_message .= "Giá hiện tại không thể trống<br>";
    }

    if(empty($_POST['p_qty'])) {
        $valid = 0;
        $error_message .= "Số lượng không thể trống<br>";
    }
    ...
    if($path!='') {
    	...
    	$valid = 0;
        $error_message .= 'Bạn phải chọn một ảnh nổi bật<br>';
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Sản phẩm được bổ sung thành công.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Old Price <br><span style="font-size:10px;font-weight:normal;">(In VND)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Current Price <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In VND)</span></label>
							<div class="col-sm-4">
